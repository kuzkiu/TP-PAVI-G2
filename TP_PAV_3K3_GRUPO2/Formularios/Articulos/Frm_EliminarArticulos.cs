...
namespace TP_PAV_3K3_GRUPO2
{
    public partial class Frm_EliminarArticulos : Form
    {
        ...
        private void grid_Articulos_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            String value = grid_Articulos.Rows[renglon].Cells[4].Value.ToString();
            int length = value.Length - 2;
            txt_costo.Text = value.Substring(0, length);
            String value2 = grid_Articulos.Rows[renglon].Cells[5].Value.ToString();
