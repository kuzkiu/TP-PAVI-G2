...
{
    public partial class Frm_BajaBarrio : Form
    {
        public Frm_BajaBarrio()
        {
            InitializeComponent();
        }

        private void Frm_BajaBarrio_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            barrio_mod.eliminar_barrio(cb_idbarrio.Text);// txt_nombreB.Text, id_localidad);
            MessageBox.Show("El barrio se ha eliminado con éxito");
            this.Close();
        }
    }
}
